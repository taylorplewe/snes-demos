...
.export Tad_AudioDriver_SIZE = 2945
.export Tad_BlankSong_Bin := __Tad_AudioData_0 + 3061
.export Tad_BlankSong_SIZE = 31
...
Tad_DataTable := __Tad_AudioData_0 + 3092
Tad_DataTable_SIZE = 146

N_DATA_ITEMS = 48
AUDIO_DATA_BANK = .bankbyte(__Tad_AudioData_0)

.import TAD_IO_VERSION
.assert TAD_IO_VERSION = 16, lderror, "TAD_IO_VERSION in audio driver does not match TAD_IO_VERSION in tad-audio.s"


.segment "BANK1"
  .assert .loword(*) = $8000, lderror, "BANK1 does not start at the beginning of a LoRom bank ($8000)"
...
.assert .sizeof(LoadAudioData) = 51, error
  ...
  __Tad_AudioData_0: .incbin "tad-out.bin", $0
  .assert .sizeof(__Tad_AudioData_0) = $7bd2, error, "tad-out.bin file size does not match binary size in the assembly file"
